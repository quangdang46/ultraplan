export function ThinkingIndicator() {
  return (
    <div className="inline-flex items-center gap-2 rounded-full bg-warm-sand/80 px-3 py-1.5 text-[12px] text-charcoal-warm">
      <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 100 100"
        className="h-4 w-4 text-terracotta motion-safe:animate-pulse"
        aria-hidden
      >
        <path
          fill="currentColor"
